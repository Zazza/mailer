<h2>Новый почтовый ящик</h2>

<form method="post" action="{{ registry.uri }}boxes/add/">
...
<div style="float: left">
	...
	<div class="par">Порт</div>
	<div class="par"><input type="text" name="out_port" id="out_port" value="25" value="{{ post.out_port }}" /></div>
	<div class="par">SSL</div>
	<div class="par">
...
<div id="text_area" style="float: left">
    <textarea id="jHtmlArea" name="textfield" style="width: 700px; height: 300px">
...
<div style="margin-top: 20px"><input type="submit" name="submit" value="Добавить" /></div>
